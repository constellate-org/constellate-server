...
export default function PanelContent(props: PanelContentProps) {
    switch (props.star.kind) {
        case "pure_markdown":
            return <></>;
        case "markdown_panel":
            return <PanelPanel star={props.star} url={props.panelUrl} isDark={props.isDark} uuid={props.uuid} />;
        case "markdown_code": {
            return <CodePanel code={props.star.code} output={props.star.output}></CodePanel>;
        }
        case "markdown_latex":
            return <LatexPanel>{props.star.latex}</LatexPanel>;
        case "markdown_matplotlib":
            return <ImagePanel filename={'/images/' + props.star.star_id + '_{}.png'} code={props.star.matplotlib} />;
    }
}
